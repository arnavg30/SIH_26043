...
const T: Translations = {
  ...
  // Auth
  "auth.email": { en: "Email Address", hi: "ईमेल पता", sa: "Email Address", kh: "Email Pata", na: "Email Pata" },
  "auth.email_placeholder": { en: "e.g. name@example.com", hi: "उदा. name@example.com", sa: "e.g. name@example.com", kh: "e.g. name@example.com", na: "e.g. name@example.com" },
  "auth.email_hint": { en: "Enter your email to continue to profile setup", hi: "प्रोफ़ाइल सेटअप जारी रखने के लिए अपना ईमेल दर्ज करें", sa: "Profile setup lagit apan email dalo", kh: "Profile setup aage badhane ke liye email dalein", na: "Profile setup aage badhane ke liye email dalein" },
  "auth.continue": { en: "Continue", hi: "आगे बढ़ें", sa: "Maha Calao", kh: "Aage Badhein", na: "Aage Badhein" },
  "auth.official_email": { en: "Official Email Address", hi: "आधिकारिक ईमेल पता", sa: "Official Email Address", kh: "Official Email Pata", na: "Official Email Pata" },
  ...
  // Profile setup
  "nav.profile": { en: "Profile", hi: "प्रोफ़ाइल", sa: "Uprom" },
  "profile.info": { en: "Profile Information", hi: "प्रोफ़ाइल जानकारी", sa: "Uprom Jankari" },
  "profile.edit": { en: "Edit Profile", hi: "प्रोफ़ाइल संपादित करें", sa: "Uprom Badlo" },
  "profile.save": { en: "Save Changes", hi: "बदलाव सहेजें", sa: "Save Karo" },
  "profile.saved": { en: "Profile updated successfully!", hi: "प्रोफ़ाइल सफलतापूर्वक अपडेट हो गई!", sa: "Profile update hoyena!" },
  "profile.role": { en: "Account Type", hi: "खाता प्रकार", sa: "Account Type" },
  "profile.verified": { en: "Verified Account", hi: "सत्यापित खाता", sa: "Satyapit Account" },
  "mitra.profile.view": { en: "Here is your profile information. You can view or update your details anytime.", hi: "यह आपकी प्रोफ़ाइल जानकारी है। आप कभी भी अपना विवरण देख या बदल सकते हैं।", sa: "Nawa aapna uprom jankari kana. Jahan khon update daareya." },
  ...
  "uni.verify_email_title": { en: "Institutional Email", hi: "संस्थान का आधिकारिक ईमेल दर्ज करें", sa: "University Official Email" },
  "uni.verify_email_sub": { en: "Enter your official university / college email to continue", hi: "आगे बढ़ने के लिए अपना आधिकारिक विश्वविद्यालय/कॉलेज ईमेल दर्ज करें", sa: "Aage badhne lagit university email dalo" },
  "uni.profile_setup": { en: "Institution Profile Setup", hi: "संस्थान प्रोफ़ाइल सेटअप", sa: "Institution Profile Setup" },
  "org.verify_email_title": { en: "Organisation Email", hi: "संगठन का आधिकारिक ईमेल दर्ज करें", sa: "Organisation Official Email" },
  "org.verify_email_sub": { en: "Enter your registered organisation email to continue", hi: "आगे बढ़ने के लिए अपना पंजीकृत संगठन ईमेल दर्ज करें", sa: "Aage badhne lagit organisation email dalo" },
  "org.profile_setup": { en: "Organisation Profile Setup", hi: "संगठन प्रोफ़ाइल सेटअप", sa: "Organisation Profile Setup" },
  "ind.verify_email_title": { en: "Official Company Email", hi: "अपना आधिकारिक कंपनी ईमेल दर्ज करें", sa: "Official Company Email" },
  "ind.verify_email_sub": { en: "Enter your official company email to continue", hi: "आगे बढ़ने के लिए अपना आधिकारिक कंपनी ईमेल दर्ज करें", sa: "Aage badhne ke liye official email dalo" },
  ...
  "mitra.name": { en: "Mitra", hi: "मित्रा", sa: "Mitra" },
  "mitra.role": { en: "Your Digital Guide", hi: "आपकी डिजिटल सहायक", sa: "Apan Digital Sahayak" },
  "mitra.welcome.title": { en: "Namaste! I’m Mitra.", hi: "नमस्ते! मैं मित्रा हूँ।", sa: "Johar! In do Mitra." },
  "mitra.welcome.sub": {
    en: "Welcome to NavJhar. I’ll help you report your problem and guide you through the process.",
    hi: "NavJhar में आपका स्वागत है। मैं आपकी समस्या दर्ज करने और उसे सही जगह पहुँचाने में मदद करूँगी।",
    sa: "NavJhar re sagun daram. In apan samasya darj ar sahi thikana te sen re madad in emoka.",
  },
  "mitra.welcome.hint": {
    en: "You can ask for help at any time.",
    hi: "आप किसी भी समय मदद ले सकते हैं।",
    sa: "Ape jahatikho madad hathao daryaka.",
  },
  "mitra.welcome.btn": { en: "Continue", hi: "आगे बढ़ें", sa: "Aage Chalo" },
  "mitra.identity.select": {
    en: "Please select your identity to report a problem.",
    hi: "कृपया अपनी पहचान चुनें कि आप किस रूप में समस्या दर्ज करना चाहते हैं।",
    sa: "Apan uprum chunao je ape chet roop te samasya darj lagit.",
  },
  "mitra.profile.default": {
    en: "Please fill in your details so we can assist you.",
    hi: "कृपया अपनी जानकारी भरें ताकि हम आपकी सहायता कर सकें।",
    sa: "Daya kate apan jankari likhao jemon aale apeya madad daryaka.",
  },
  "mitra.profile.email": { en: "Enter your email address to get started.", hi: "शुरू करने के लिए अपना ईमेल पता दर्ज करें।", sa: "Shuru lagit apan email dalo." },
  ...
  "mitra.dash.hint": {
    ...
    hi: "अपनी समस्या दर्ज करने के लिए नीचे दिए गए बटन पर टैप करें।",
    sa: "Apan samasya darj lagit latar re button dabawo.",
  },
  "mitra.rep.step1": {
    en: "Tell me about your problem. You can speak or type.",
    hi: "अपनी समस्या बताइए। आप बोलकर भी बता सकते हैं या टाइप कर सकते हैं।",
    sa: "Apan samasya lai-me. Ape ror kate ho baang likh kate batao daryaka.",
  },
  "mitra.rep.step1.listening": {
    en: "I am listening, please speak...",
    hi: "मैं सुन रही हूँ, कृपया बोलिए...",
    sa: "In aanjom eda, daya kate ror-me...",
  },
  "mitra.rep.step2": {
    en: "Now tell me where the problem is.",
    hi: "अब मुझे बताइए कि समस्या कहाँ है।",
    sa: "Nit lai-me je samasya okare menak-a.",
  },
  "mitra.rep.step3": {
    en: "Please check your details once. Then submit your problem.",
    hi: "सब कुछ एक बार जाँच लें। फिर समस्या दर्ज करें।",
    sa: "Jotak mit dhao janch-me. Tayom samasya submit-me.",
  },
  "mitra.rep.success": {
    en: "Great job! Your problem has been successfully submitted.",
    hi: "बहुत बढ़िया! आपकी समस्या सफलतापूर्वक दर्ज हो गई है।",
    sa: "Adi bes! Apeya samasya saphalta purwak darj hoe-ena.",
  },
  "mitra.rep.track": {
    en: "You can track the progress of your problem anytime from here.",
    hi: "आप यहाँ से अपनी समस्या की प्रगति कभी भी देख सकते हैं।",
    sa: "Ape nahan khon apan samasya roop track daariya.",
  },

  // Additional citizen & report translations
  "cit.myrecent": { en: "My Recent Problems", hi: "मेरी हालिया समस्याएं", sa: "Apan Nitiak Samasya" },
  "auth.otp_sent": { en: "OTP Sent", hi: "OTP भेजा गया", sa: "OTP Bhejalena" },
  "auth.otp_sent_hint": { en: "Enter the 6-digit code sent to your number", hi: "अपने नंबर पर भेजा गया 6 अंकों का कोड दर्ज करें", sa: "Apan number te bhejal 6 digit code likhao" },
  "rep.step1.tap_to_speak": { en: "Tap to start speaking", hi: "बोलने के लिए टैप करें", sa: "Ror lagit tap me" },
  "rep.step1.listening_text": { en: "Listening…", hi: "सुन रहे हैं…", sa: "Aanjom eda…" },
  "rep.step1.use_text": { en: "Use this text", hi: "इस टेक्स्ट का उपयोग करें", sa: "Niyan text use me" },
  "rep.step1.describe": { en: "Describe the problem", hi: "समस्या का विवरण दें", sa: "Samasya lai-me" },
  "rep.step1.take_photo": { en: "Take Photo", hi: "फोटो खींचें", sa: "Photo Tulo" },
  "rep.step1.upload_photo": { en: "Upload Photo", hi: "फोटो अपलोड करें", sa: "Photo Upload Me" },
  "rep.step1.upload_video": { en: "Upload Video", hi: "वीडियो अपलोड करें", sa: "Video Upload Me" },
  "rep.step2.map_hint": { en: "Click the map to set problem location", hi: "समस्या का स्थान तय करने के लिए नक्शे पर क्लिक करें", sa: "Samasya jagha thik lagit map re click me" },
  "rep.step2.drag_hint": { en: "Drag to move", hi: "खिसकाने के लिए खींचें", sa: "Hasawe lagit tan-me" },
  "rep.step3.summary": { en: "Your Report Summary", hi: "आपकी रिपोर्ट का सारांश", sa: "Apeya Report Saransh" },
  "rep.step3.desc_label": { en: "Problem Description", hi: "समस्या का विवरण", sa: "Samasya Lai" },
  "rep.step3.loc_label": { en: "Location", hi: "स्थान", sa: "Jagha" },
  "rep.step3.ai_handle": { en: "AI will automatically handle:", hi: "AI अपने आप प्रबंधित करेगा:", sa: "AI aapon te handle daariya:" },
  "success.save_hint": { en: "Save this to track your problem", hi: "अपनी समस्या ट्रैक करने के लिए इसे संभाल कर रखें", sa: "Apan samasya track lagit jogaw-me" },
};
