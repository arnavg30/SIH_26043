...
CREATE TABLE problems (
    ...
    original_text           TEXT,                        -- Original user-provided/transcribed text
    ...
    required_skills         TEXT,                        -- AI-suggested skills needed to solve the problem
    expected_impact         TEXT,                        -- AI-generated expected-impact suggestion shown on frontend
...
CREATE INDEX idx_problems_duplicate_of ON problems(duplicate_of_id);
